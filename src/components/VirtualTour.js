...
function VirtualTour() {
  ...
  return (
    <div  className='bg-slate-900 w-full h-screen flex flex-col items-center'>
       <h1 className='text-4xl font-bold text-center text-white mt-8'>Virtual Tour <br/> Studio Ampu</h1>
      <div className='w-4/5 m-auto flex h-4/5 justify-between items-center'>
       <div className='w-1/5 h-4/5 overflow-y-scroll scrollbar-none'>
      {imgs.map((data,i) => {
        return(<div  key={i}>
