...
function Tim() {
  ...
  return (
    <div className='w-4/5 m-auto min-h-screen pt-14'>
      <h1 className='text-4xl font-bold mb-3'>Semua Tim Kami</h1>
      <p className='text-2xl font-medium mt-3 mb-3'>Semua yang berkontribusi dalam mengembangkan Ampu Studio.</p>
      <div className=' w-full h-screen flex justify-center flex-col'>

          <div className='grid grid-cols-4 gap-y-12 gap-x-0 place-items-center mt-24 pt-24'>
